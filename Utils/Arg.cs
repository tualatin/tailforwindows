...
namespace Org.Vs.TailForWin.Utils
{
  ...
  public sealed class Arg
  {
    ...
    {
      if(arg > maxValue)
        throw new ArgumentException(FormatErrorMessage(source, argName, ERR_ATMOST, maxValue, arg));
    ...
    {
      if(arg >= maxValue)
        throw new ArgumentException(FormatErrorMessage(source, argName, ERR_LOWERTHAN, maxValue, arg));
    ...
    public static T IsA<T>(object source, object arg, string argName)
    {
      ...
      if(arg == null || !(arg is T))
        throw new ArgumentException(FormatErrorMessage(source, argName, ERR_EXPECTED_CLASS, argClass.Name, arg != null ? arg.GetType().Name : null));
    ...
    public static Type IsA(object source, Type arg, Type argClass, string argName)
    {
      ...
      if(arg == null || !argClass.DeclaringType.IsAssignableFrom(arg.DeclaringType))
        throw new ArgumentException(FormatErrorMessage(source, argName, ERR_EXPECTED_CLASS, argClass.Name, arg != null ? arg.Name : null));
    ...
    public static T SubclassOf<T>(object source, object arg, string argName)
    {
      ...
      if(!(arg is T) || argClass.Equals(arg.GetType()))
        throw new ArgumentException(FormatErrorMessage(source, argName, ERR_EXPECTED_SUB_CLASS, argClass.Name, arg != null ? arg.GetType().Name : null));
    ...
    public static Type SubclassOf(object source, Type arg, Type argClass, string argName)
    {
      ...
      if(arg == null || argClass.Equals(arg) || !argClass.IsAssignableFrom(arg))
        throw new ArgumentException(FormatErrorMessage(source, argName, ERR_EXPECTED_SUB_CLASS, argClass.Name, arg != null ? arg.Name : null));
    ...
    public static T OneOf<T>(object source, string arg, string argName) where T : struct, IConvertible
    {
      ...
      if(arg != null && enumClass.IsEnum)
      {
        ...
        {
          throw new ArgumentException(FormatErrorMessage(source, argName, ERR_VALUE_NOT_VALID, enumClass.Name, string.Join(",", EnumValues<T>())));
        }
      }
