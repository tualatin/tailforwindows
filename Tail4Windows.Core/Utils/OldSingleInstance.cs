...
namespace Org.Vs.Tail4Win.Core.Utils
{
  ...
  /// </summary>
  public class OldSingleInstance : IDisposable
  {
    private static readonly ILog LOG = LogManager.GetLogger(typeof(OldSingleInstance));
    ...
    /// </summary>
    /// <param name="appGuid"><see cref="Guid"/></param>
    public OldSingleInstance(Guid appGuid)
    {
      _appGuid = appGuid;
    ...
    /// <summary>
    /// Release all resources used by <see cref="OldSingleInstance"/>
    /// </summary>
    public void Dispose()
    {
      Dispose(true);
