...
namespace Org.Vs.TailForWin.Ui.PlugIns.BasicWindow
{
  ...
  public partial class MainWindowToolbarButtons
  {
    ...
    /// </summary>
    public static readonly DependencyProperty MaximizeButtonVisibilityProperty = DependencyProperty.RegisterAttached(
      "MaximizeButtonVisibility",
      typeof(Visibility),
      typeof(MainWindowToolbarButtons),
    ...
    /// </summary>
    public static readonly DependencyProperty RestoreButtonVisibilityProperty = DependencyProperty.RegisterAttached(
